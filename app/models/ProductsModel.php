...
class ProductsModel extends Connect{
    ...
    public function getDetail($id){
        ...
        if($result){
            $product = new ProductsModel($result['idProduct'], $result['name'], $result['price'], $result['salePrice'],
                                            $result['discription'], $result['image'], $result['listImages'], 
                                            $result['condition'], $result['quantity'], $result['status'], $result['view'], $result['createdAt'], $result['updatedAt'], $result['idCategory']);
            return $product;
        }
        return null;
    }
