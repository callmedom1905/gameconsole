...
<div class="col-12">
    <div class="bg-light rounded h-100 p-4">
        ...
        <a class="btn btn-secondary rounded-pill m-2" href="/gameconsole/admin/categories">Trở lại</a>
            <form action="/gameconsole/admin/action-add-category" method="post" enctype="multipart/form-data">  

                <input class="form-control mb-3" type="text" name="name" placeholder="Tên danh mục" aria-label="default input example">
                ...
                <input class="form-control mb-3" type="text" name="url" placeholder="Tên đường dẫn" aria-label="default input example">
